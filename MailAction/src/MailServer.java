...
/**
 * Created by DHPLAKMAL on 10/13/2015.
 */
public class MailServer {

    protected static void sendMail(String[] to, String from, String subject, String body, String status, Session session){
...
//                DataSource statusSuccess = new FileDataSource(String.valueOf(this.getClass().getResource("/com/virtusa/tempo/server/ui/views/images/icons/16/success.png").getFile()));
    ...
    protected static Session setSMTPConfig(String authUsername, String AuthPassword, String domain, String port) {
